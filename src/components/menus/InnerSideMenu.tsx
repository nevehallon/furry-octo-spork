...
const { innerSideMenu, collapsed, shrink, group446, frame2, pageTitle, menuItem, contractTypes, ellipse68 } = styles;
    ...
    <div className={`${innerSideMenu} ${hidden && collapsed} ${hide && shrink}`}>
      <div className={group446}>
        ...
        <div className={menuItem}>
          ...
          <span className={contractTypes}>Create new tenancy contract</span>
